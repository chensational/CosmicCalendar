...
| Realistic time-changing planet features | IAU body-fixed bases, supersampled spherical albedo shader, Lambert terminators, material highlights, projected/occluded Saturn rings | Axis orthogonality and lighting tests, build/type tests, visual/performance audit | Verified procedural physical-lighting model; not cartographic texture imagery |
